...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "hw6", table_name = "dev_csv", transformation_ctx = "datasource0")
...
datasink2 = glueContext.write_dynamic_frame.from_options(frame = mapping1, connection_type = "s3", connection_options = {"path": "s3://ieor4577-hw6/dev"}, format = "json", transformation_ctx = "datasink2")
job.commit()